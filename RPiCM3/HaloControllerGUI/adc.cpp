...
void ADC::getJoystickChannels(channels& rcChannels) {
    ...
    rcChannels.pitchPWM = pointsToPWM(rawADCPoints[4]);
    rcChannels.rollPWM = pointsToPWM(rawADCPoints[3]);
    rcChannels.yawPWM = pointsToPWM(rawADCPoints[1]);
    rcChannels.throttlePWM = pointsToPWM(rawADCPoints[2]);
